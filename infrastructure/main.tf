# -----------------------------------------------------------------------
# Terraform Configuration — Diagram-to-Terraform Application
# Provisions: S3, ECR, ECS Fargate, ALB, IAM, VPC
# -----------------------------------------------------------------------
...
terraform {
  ...
  #   key    = "nova-architect/terraform.tfstate"
  #   region = "us-east-1"
  # }
}
...
# Bedrock access for Amazon Nova
...
resource "aws_ecs_task_definition" "backend" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      ...
      { name = "S3_BUCKET", value = aws_s3_bucket.diagrams.id },
